            ...
            <div class="card">
              <div class="card-header">
                  <div class="row">
                      ...
                      <div class="col-2">
                          <a href="<?php echo base_url('admin/Packages/addPackage') ?>" class="btn btn-block btn-primary">Create Package</a>
                      </div>
                  </div>
              </div>
              <!-- /.card-header -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      <tr>
                          ...
                          $status = 0;
                          if($row->status == 1){
                              $status= '<span class="right badge badge-danger">Deactive</span>';
                          }else{
                          ...
                          <td><a href="javascript:;"  class="text-danger item_delete w-4 h-4 mr-1" data="<?php echo $row->id?>"><i class="fas fa-trash-alt"></i></a>&nbsp;&nbsp;<a href="javascript:;"  class="text-primary item_edit w-4 h-4 mr-1" data="<?php echo $row->id?>"><i class="fas fa-pen-alt"></i></a></td>
			                            ...
			                            <div class="col-md-4 mr-4">
			                                ...
			                                <div class="custom-file">
			                                    <input type="file" class="custom-file-input" id="customFile"
			                                        onchange="loadFile(event)" name="image" accept="image">
			                                    <label class="custom-file-label" for="customFile">Choose file</label>
			                                </div>
			                            </div>
			                            <div class="col-md-4">
			                                <img src="<?php echo base_url()?>demo.png" width="30%" id="blah">
			                            </div>
			                        </div>
			                    </div>
                </div>
